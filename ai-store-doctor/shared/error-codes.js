;(function (root) {
  ...
  const CODES = {
    ...
    TOKEN_INPUT_BUDGET_EXCEEDED: 'TOKEN_INPUT_BUDGET_EXCEEDED',
    TOKEN_OUTPUT_BUDGET_EXCEEDED: 'TOKEN_OUTPUT_BUDGET_EXCEEDED',
  ...
  function is(code, expected) {
    ...
    if (expected === 'LENGTH_ERROR' && (code === 'OUTPUT_TRUNCATED' || a === 'LENGTH_ERROR')) return true
    if (expected === 'OUTPUT_TRUNCATED' && (code === 'LENGTH_ERROR' || a === 'OUTPUT_TRUNCATED')) return true
    return false
  }
