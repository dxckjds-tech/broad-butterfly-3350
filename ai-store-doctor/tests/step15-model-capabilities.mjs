...
assert(unknown.structuredOutput === false, 'unknown structuredOutput stays false')
const openaiUnknown = caps.resolve('openai', 'gpt-future-unknown')
assert(openaiUnknown.vision === false && openaiUnknown.reasoning === false, 'openai unknown must not inherit provider vision')
const qwenUnknown = caps.resolve('qwen', 'qwen-future-unknown')
assert(qwenUnknown.vision === false && qwenUnknown.reasoning === false, 'qwen unknown safe')
const kimiUnknown = caps.resolve('moonshot', 'kimi-future-unknown')
assert(kimiUnknown.vision === false && kimiUnknown.reasoning === false, 'moonshot unknown safe')
