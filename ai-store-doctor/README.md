...
当前版本：`1.6.4`（以 `EXTENSION_VERSION` 为准）。
...
- 智能自动模型路由（平衡 / 省钱 / 最佳质量）
- 用户可配置多模型协作（Evidence / Reasoning / Keywords / Content / Verifier；AUTO / CUSTOM / SINGLE / HYBRID）
- 三阶段商品诊断协同（证据 / 诊断 / 内容，最多 4 次调用；同模型可合并 Role）
- AI 诊断
